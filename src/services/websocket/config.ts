//Every tunable number in the WebSocket system lives here. When you want to change how often we ping the server, how long to wait before giving up on a reconnect, or which tokens to subscribe to by default — you change this file only. No logic code needs to change.
// ─────────────────────────────────────────────────────────────────────────────
// services/websocket/config.ts
// All tunable knobs for the live-market WebSocket connection
// ─────────────────────────────────────────────────────────────────────────────
