//Without this hook, you'd have to manually wire WsManager to the store in every component.By mounting once in App.tsx, the connection is shared across the entire app.The hook handles the entire lifecycle — connect on mount, disconnect on unmount.
// ─────────────────────────────────────────────────────────────────────────────
// shared/hooks/useLiveMarketWs.ts
// Mount this hook ONCE at the top of the app (e.g. in App.tsx).
// It wires WsManager → Zustand store and manages the full connection lifecycle.
// ─────────────────────────────────────────────────────────────────────────────
