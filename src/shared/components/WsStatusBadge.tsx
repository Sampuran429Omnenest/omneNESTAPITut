//Users need to know if live prices are flowing or if the connection has dropped. This badge shows a coloured dot and status label in the footer. It's a pure read-only component — reads from the store, renders, that's it.
