//When something goes wrong with the live connection during development or QA, you need visibility into what the WsManager is doing. WsDebugPanel shows heartbeat stats, retry counts, and a live scrolling log of every lifecycle event.
//NOTE  This component is for development only. Wrap it in {isDev && <WsDebugPanel />} so it never appears in production. The isDev flag is typically process.env.NODE_ENV !== 'production'.
// ─────────────────────────────────────────────────────────────────────────────
// widgets/WsDebugPanel/WsDebugPanel.tsx
// Developer panel: shows lifecycle events, ping/pong counters, connection log.
