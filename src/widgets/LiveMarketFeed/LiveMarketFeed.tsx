//LiveMarketFeed is a drop-in side panel that shows the latest live price for every subscribed token. It's useful during development to verify that ticks are arriving, and can be shown to users as a market overview panel.
